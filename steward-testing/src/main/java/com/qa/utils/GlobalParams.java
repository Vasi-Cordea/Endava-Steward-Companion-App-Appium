...
public class GlobalParams {
    ...
    public void initializeGlobalParams(){
        ...
        params.setDeviceName(System.getProperty("deviceName", "Pixel 3"));

        switch(params.getPlatformName()){
            case "Android":
                params.setSystemPort(System.getProperty("systemPort", "10003"));
                params.setChromeDriverPort(System.getProperty("chromeDriverPort", "11003"));
                break;
            case "iOS":
